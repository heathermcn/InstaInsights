...
const IconButton = (0, react_1.memo)((0, react_1.forwardRef)(function IconButton(props, ref) {
    const { icon, iconSize } = props, restProps = __rest(props
    // modifiers
    , ["icon", "iconSize"]);
    // modifiers
    ...
    return (react_1.default.createElement(Button_1.default, Object.assign({ ref: ref, paddingLeft: 0, paddingRight: 0, flex: "none", height: height, width: height, minWidth: height }, restProps),
        react_1.default.createElement(IconWrapper_1.IconWrapper, { icon: icon, color: intent === 'none' ? 'default' : 'currentColor', size: iconSize || relativeIconSize })));
}));

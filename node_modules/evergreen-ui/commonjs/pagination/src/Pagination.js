    ...
    return (react_1.default.createElement(layers_1.Pane, Object.assign({ is: "nav", role: "navigation", "aria-label": "Pagination" }, rest, { ref: ref }),
        react_1.default.createElement(layers_1.Pane, { is: "ul", display: "flex", alignItems: "center", padding: 0 },
            react_1.default.createElement(layers_1.Pane, { is: "li", listStyle: "none" },
                react_1.default.createElement(buttons_1.IconButton, { appearance: "minimal", icon: icons_1.ChevronLeftIcon, disabled: page === 1, onClick: onPreviousPage })),
            totalPages
                ...
                : null,
            react_1.default.createElement(layers_1.Pane, { is: "li", listStyle: "none" },
                react_1.default.createElement(buttons_1.IconButton, { appearance: "minimal", icon: icons_1.ChevronRightIcon, disabled: totalPages ? page === totalPages : undefined, onClick: onNextPage })))));
}));
